...
@Component({
  selector: 'app-vac-pl-choose-payment-method',
  templateUrl: './vac-pl-choose-payment-method.component.html',
  styleUrls: ['./vac-pl-choose-payment-method.component.scss'],
})
export class VacPlChoosePaymentMethodComponent implements OnInit {
