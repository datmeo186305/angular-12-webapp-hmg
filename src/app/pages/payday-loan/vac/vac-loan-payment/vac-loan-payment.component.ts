...
@Component({
  selector: 'app-vac-loan-payment',
  templateUrl: './vac-loan-payment.component.html',
  styleUrls: ['./vac-loan-payment.component.scss'],
})
export class VacLoanPaymentComponent implements OnInit, OnDestroy {
