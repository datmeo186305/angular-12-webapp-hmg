...
import {ERROR_CODE, PAYDAY_LOAN_STATUS, PL_STEP_NAVIGATION,} from '../../../../core/common/enum/payday-loan';
...
@Component({
  selector: 'app-tng-ekyc',
  templateUrl: './tng-ekyc.component.html',
  styleUrls: ['./tng-ekyc.component.scss'],
})
export class TngEkycComponent implements OnInit, OnDestroy {
  customerInfo: any;
