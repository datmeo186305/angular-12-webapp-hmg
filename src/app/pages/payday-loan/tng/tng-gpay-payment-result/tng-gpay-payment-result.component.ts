...
@Component({
  selector: 'app-tng-gpay-payment-result',
  templateUrl: './tng-gpay-payment-result.component.html',
  styleUrls: ['./tng-gpay-payment-result.component.scss'],
})
export class TngGpayPaymentResultComponent implements OnInit, OnDestroy {
  ...
  ngOnInit(): void {
    ...
    //   'Kết quả thanh toán' + ' - ' + environment.PROJECT_NAME
    // );
