...
@Component({
  selector: 'app-tng-sign-contract-success',
  templateUrl: './tng-sign-contract-success.component.html',
  styleUrls: ['./tng-sign-contract-success.component.scss'],
})
export class TngSignContractSuccessComponent implements OnInit, OnDestroy {
  firstName: string = '';
  loanCode: string = '';
