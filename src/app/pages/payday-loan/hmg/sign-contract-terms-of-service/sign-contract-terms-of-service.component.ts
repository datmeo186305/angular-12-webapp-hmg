...
export class SignContractTermsOfServiceComponent implements OnInit, OnDestroy {
  ...
  ngOnInit(): void {
    ...
    //   'Ký thư chấp thuận' + ' - ' + environment.PROJECT_NAME
    // );
  ...
  private _initSubscribeState() {
        ...
        (isSignContractTermsSuccess) => {
          ...
          if (this.isSignContractTermsSuccess) {
            return this.router.navigateByUrl(
              '/hmg/sign-approval-letter-success'
            );
          }
        }
      )
    ...
    if (this.isSignContractTermsSuccess) {
      return this.router.navigateByUrl('/hmg/sign-approval-letter-success');
    }
  ...
  sendLetterOtp() {
    ...
    this.contractControllerService
      .sendLetter(COMPANY_NAME.HMG, params)
      .subscribe(
    ...
    this.subManager.add(
      this.infoControllerService
        ...
        .subscribe((response) => {
          ...
          this.router.navigateByUrl('/hmg/sign-approval-letter-success');
        })
    );
  }
